"""Generate skills/do-upskill/topics.json from the upskill config."""
...
def _load_topics(templates_dir: Path = TEMPLATES_DIR) -> list[TopicConfig]:
    ...
    config_path = templates_dir / "do-upskill" / "config.py"
...
def generate_topics_json(output_dir: Path = SKILLS_OUTPUT_DIR) -> Path:
    ...
    output_path = output_dir / "do-upskill" / "topics.json"
