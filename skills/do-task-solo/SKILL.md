...
**Depends on:** mav-scope-boundaries, mav-git-workflow, create-solution-design, create-implementation-plan, task-breakdown, mav-plan-execution, mav-local-verification, mav-bp-cicd, mav-claude-code-recovery, mav-bp-logging, mav-bp-alerting, mav-systematic-debugging, pullrequest-review
